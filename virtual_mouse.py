...
def countFingers(image, hand_landmarks, handNo=0):
	...
	if hand_landmarks:
        ...
        cv2.line(image,(finger_tip_x,finger_tip_y),(thumb_tip_x,thumb_tip_y),'red',5)
		# Draw a CIRCLE on CENTER of the LINE between FINGER TIP and THUMB TIP

        x_center = int((finger_tip_x+thumb_tip_x)/2)
        y_center = int((finger_tip_y+thumb_tip_y)/2)

        cv2.circle(image,(x_center,y_center),1,"pink",5)
